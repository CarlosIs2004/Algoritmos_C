...
{
    internal class RecorteGeometrico
    {
        ...
        public static PointF[] CohenSutherlandClipping(List<PointF> points, PointF[] pointsCanvas)
        {
            ...
            for (int i = 0; i < points.Count / 2; i++)
            {
                ...
                else if ((Bloque1 && Bloque2) || (Bloque1 ^ Bloque2))
                {
                    if (Bloque1 && Bloque2)
                    {
                        ...
                        {
                            PointF interseccion1 = RecorteGeometrico.InterseccionSimple(points[auxIndex - 1], points[auxIndex], canvaInitPoint1, canvaEndPoint1);
                            if (interseccion1 != PointF.Empty)
                                clipedPoints.Add(interseccion1);
                        }
                        if (canvaInitPoint2 != PointF.Empty && canvaEndPoint2 != PointF.Empty)
                        {
                            PointF interseccion2 = RecorteGeometrico.InterseccionSimple(points[auxIndex - 1], points[auxIndex], canvaInitPoint2, canvaEndPoint2);
                    ...
                    if (Bloque1 ^ Bloque2)
                    {
                        ...
                        {
                            PointF inter = RecorteGeometrico.InterseccionSimple(points[auxIndex - 1], points[auxIndex], border.Item1, border.Item2);
        ...
        public static PointF[] SutherlandHodgmanClipping(List<PointF> points, PointF[] pointsCanvas)
        {
            List<PointF> clipedPoints = new List<PointF>();
